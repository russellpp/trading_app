...
import { clearAddFunds, clearAddUser } from "../../redux/modalReducer";
import { useAdmin } from "../../hooks/useAdmin";

function AddUserModal() {
  const dispatch = useDispatch();
  const { getUserList } = useAdmin();
  const { createTrader } = useAdmin();
  ...
  return (
    <ModalContainer>
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <ModalFooter>
          <FormSubmitButton type="submit" value="CREATE USER" />
